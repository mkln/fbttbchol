      SUBROUTINE MB02CDmod( JOB, TYPET, K, N, T, LDT, G, LDG, R, LDR, L,
...
C     .. Scalar Arguments ..
      CHARACTER         JOB, TYPET
      INTEGER           INFO, K, LCS, LDG, LDL, LDR, LDT, LDWORK, N, NK
C     .. Array Arguments ..
...
C     .. External Subroutines ..
     ...
     $                  XERBLA, toeplitz_cholesky_lower_i
...
C
C !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
C        CALL DPOTRF( 'Lower', K, T, LDT, IERR )
C
C        TOEPLITZ BLOCK: HENCE DO TOEPLITZ CHOLESKY
C
         CALL toeplitz_cholesky_lower_i(T, LDT, K)
         IERR = 0
C        IF ( IERR.NE.0 )  THEN
C
